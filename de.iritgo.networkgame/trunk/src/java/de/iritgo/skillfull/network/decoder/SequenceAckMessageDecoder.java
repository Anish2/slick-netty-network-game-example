...
public class SequenceAckMessageDecoder extends OneToOneDecoder
{
	@Override
	protected Object decode (ChannelHandlerContext ctx, Channel channel, Object msg) throws Exception
	{
		if (msg instanceof ChannelBuffer)
		{
			...
			if (Opcode.fromByte (opcode) == Opcode.SEQUENCE_ACK)
			{
				SequenceAckMessage ack = new SequenceAckMessage (buffer.readInt (), -1);
				ack.setSubSequenceId (buffer.readInt ());
